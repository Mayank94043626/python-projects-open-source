...
theme_selector = tk.Menu(menubar, tearoff=0)
theme_selector.add_command(label="Light", command=light_theme)
theme_selector.add_command(label="Dark", command=dark_theme)
menubar.add_cascade(label="Theme", menu=theme_selector)
